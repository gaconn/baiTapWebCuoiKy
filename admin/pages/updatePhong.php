<div class="update">
    ...
    <form class="update-dialog" action="<?php echo $updateControl ?>" method="post">
        ...
        <div>
            Mã phòng <input type="text" name="maPhong" readonly value="<?php echo $phong["MaPhong"] ?>"
                class="form-control">
            Tên phòng <input type="text" name="tenPhong" value="<?php echo $phong["TenPhong"] ?>" class="form-control"
                required>
        </div>
        <div class="choice">
